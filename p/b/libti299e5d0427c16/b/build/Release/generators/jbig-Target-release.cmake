...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET JBIG::JBIG
                 ...
                 $<$<CONFIG:Release>:${jbig_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET JBIG::JBIG
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${jbig_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET JBIG::JBIG
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${jbig_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET JBIG::JBIG
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${jbig_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET JBIG::JBIG
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${jbig_COMPILE_OPTIONS_RELEASE}> APPEND)
