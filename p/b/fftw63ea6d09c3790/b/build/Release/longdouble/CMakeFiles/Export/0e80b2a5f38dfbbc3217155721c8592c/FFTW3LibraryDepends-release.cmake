...
set_target_properties(FFTW3::fftw3l PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libfftw3l.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libfftw3l.3.6.9.dylib"
  )

list(APPEND _cmake_import_check_targets FFTW3::fftw3l )
list(APPEND _cmake_import_check_files_for_FFTW3::fftw3l "${_IMPORT_PREFIX}/lib/libfftw3l.3.dylib" )
