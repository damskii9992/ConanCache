...
HDF5 1.14 that was compiled on;
    Darwin 23.3.0 arm64, using AppleClang C 15.0.0.15000040.
...
The contents of this directory are:
    ...
    README.md               - This file
    HDF5-1.14.3-Darwin.sh    - HDF5 Install Package
...
Installation
===========================================================================
1. Execute HDF5-1.14.3-Darwin.sh
2. Follow prompts
===========================================================================
...
To test the installation with the examples;
    ...
    The default installation folder is defined as "/Users/runner/_work/imagingsuite/imagingsuite/Cache/p/b/hdf5228868ffdc3ba/p".
